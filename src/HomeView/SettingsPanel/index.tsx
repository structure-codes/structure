  ...
  return (
    <div className={classes.settingsContainer}>
      ...
      <FormGroup>
        <FormControlLabel
          control={
            <Checkbox checked={settings.hideFiles} onChange={handleCheckboxChange} name="hideFiles" color="secondary" />
          }
          label="Hide files"
        />
        <FormControlLabel
          control={
            <Checkbox checked={settings.hideDotDirs} onChange={handleCheckboxChange} name="hideDotDirs" color="secondary" />
          }
